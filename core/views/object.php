...
<!--					</tr>-->
            ...
            <section class="reg">
                ...
                <form class="reg-form" action="" method="post" id="contact">
                    <input type="text" name="name" placeholder="Ваше имя"></input><span></span>
                    <input type="tel" name="tel" placeholder="Ваш телефон"></input><span></span>
                    <input type="email" name="email" placeholder="Ваш E-mail"></input><span></span>
